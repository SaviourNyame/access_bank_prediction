...
export const TRIVIA_SEEDS: SeedQuestion[] = [
  ...
  {
    question: "What is the name of Ghana's national football team?",
    options: { A: "The Golden Stars", B: "The Black Stars", C: "The Shooting Stars", D: "The Black Eagles" },
    correct: "B",
    timer: 10,
    difficulty: "easy",
  },
  {
    question: "Which club does Mohammed Kudus play for?",
    options: { A: "Chelsea", B: "Arsenal", C: "West Ham United", D: "Manchester City" },
    correct: "C",
    timer: 15,
    difficulty: "medium",
  },
  {
    question: "Which Ghanaian player scored Ghana's first ever World Cup goal in 2006?",
    options: { A: "Sulley Muntari", B: "Asamoah Gyan", C: "Michael Essien", D: "Haminu Draman" },
    correct: "A",
    timer: 20,
    difficulty: "medium",
  },
  {
    question: "In which city is Ghana's national football stadium located?",
    options: { A: "Kumasi", B: "Tamale", C: "Accra", D: "Cape Coast" },
    correct: "C",
    timer: 15,
    difficulty: "easy",
  },
  {
    question: "Which Ghanaian player was known as 'The Bison' for his powerful midfield play at Chelsea?",
    options: { A: "Abedi Pele", B: "Asamoah Gyan", C: "Michael Essien", D: "Anthony Yeboah" },
    correct: "C",
    timer: 15,
    difficulty: "medium",
  },
  {
    question: "Ghana qualified for the 2026 World Cup from which African confederation?",
    options: { A: "COSAFA", B: "WAFU", C: "CAF", D: "CECAFA" },
    correct: "C",
    timer: 10,
    difficulty: "easy",
  },
  {
    question: "Which Access Bank partner event are you at right now?",
    options: { A: "Access Bank Viewing Centre", B: "FIFA Fan Zone", C: "CAF Headquarters", D: "Ghana FA Grounds" },
    correct: "A",
    timer: 10,
    difficulty: "easy",
  },
